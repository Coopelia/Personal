...
public class CUpdateActivity  extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> arrayAdapter = ArrayAdapter.createFromResource(
                this,R.array.category_out,android.R.layout.simple_spinner_item);
        ...
        String ca=userOut.getCategory();
        String[] labels=getResources().getStringArray(R.array.category_out);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.button5:
                ...
                //第三个参数：修改的条件
                //第四个参数:修改的条件的值的数组
                db.update("user_out",contentValues,"_id=?",new String[]{String.valueOf(id)});
